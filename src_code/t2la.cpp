...
{
	acedCommand(RTSTR,_T("SETVAR"),RTSTR,_T("CMDECHO"),RTSTR,_T("0"),0); //设置命令反应关闭.
	
	acedCommand(RTSTR,_T("ZOOM"),RTSTR,_T("W"),RTPOINT,m_ptTextLeft,RTPOINT,m_ptTextRight,0);//放大该文字ss1
	...
	getLUL();
	acedCommand(RTSTR,_T("WMFOUT"),RTSTR,textfilename,RTENAME,ss1,RTSTR,_T(""),0);
	acedCommand(RTSTR,_T("ERASE"),RTENAME,ss1,RTSTR,_T(""),0);
	//acedCommand(RTSTR,_T("ERASE"),RTENAME,ss1,0);
	acedCommand(RTSTR,_T("WMFIN"),RTSTR,textfilename,RTPOINT,m_lul,RTSTR,_T("2.0008"),RTSTR,_T(""),RTSTR,_T(""),0);
	
	acedCommand(RTSTR,_T("SETVAR"),RTSTR,_T("CMDECHO"),RTSTR,_T("1"),0); //设置命令反应关闭.
}
