...
double 
checkarc_poly(long *pNumbadarc,long *plNumarc,AcDbPolyline* pPoly)
{
	double max_rdu = 0.0;
	//double tmp_rdu;
...
double 
checkarc(long *pNumbadarc,long *plNumarc,AcDbArc* pArc)
{
    (*plNumarc)+=1;
...
double 
check_circle(long *pNumbadarc,long *plNumarc,AcDbCircle* pCircle)
{
    (*plNumarc)+=1;
...
void 
rptarcvertex(AcGeCircArc2d arc2d)
{
